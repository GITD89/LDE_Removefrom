...
class DoubleLinkedList {
    ...
    removeFrom(index){
        ...
        if(index === this.size-1){
            ...
            // const valueToReturn = this.tail.back.dato;
            let current = this.head;
            let previous;
            let currenNext;
            ...
            previous.next = currenNext;
            currenNext.back = previous;
...
LISTADE.insertFirst(1);
LISTADE.insertFirst(2);
LISTADE.insertFirst(3);
LISTADE.insertFirst(4);
LISTADE.print();